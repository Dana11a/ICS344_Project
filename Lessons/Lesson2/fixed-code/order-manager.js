...
//  ADDED: Verify JWT using Cognito

const { LambdaClient, InvokeCommand } = require("@aws-sdk/client-lambda");
const { CognitoIdentityProviderClient, AdminGetUserCommand } = require("@aws-sdk/client-cognito-identity-provider");
const jose = require('node-jose');

// Lesson2 Fix 1 start here: Adds JWT signature verification using Cognito JWKS so only valid, untampered tokens are accepted
...
exports.handler = (event, context, callback) => {
    ...
    // Lesson2 Fix 2 start here: Verify JWT using Cognito
    ...
    // Lesson2 FIX3: Handle JWT verification failure and reject invalid/forged tokens with 401 response
}).catch((e) => {
